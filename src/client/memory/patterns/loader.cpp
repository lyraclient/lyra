...
namespace selaura {
    void resolve_signatures() {
        selaura::patterns::resolve_all_signatures_parallel({
            ...
            {"onUri", [&] { return RESOLVE_SIG(&GameArguments::_onUri_hk); }},
            {"setupAndRender", [&] { return RESOLVE_SIG(&ScreenView::setupAndRender_hk); }},
            {"createBaseLightTextureData", [&] { return RESOLVE_SIG(&BaseLightTextureImageBuilder::createBaseLightTextureData_hk); }}
        });
    }
}
